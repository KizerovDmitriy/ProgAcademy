...
public class ApartmentsDAOImpl implements ApartmentsDAO {
    ...
    public void createTable() {
        try (Statement st = connection.createStatement()) {
            ...
            st.execute("CREATE TABLE Apartments (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, region VARCHAR(30) NOT NULL, address VARCHAR(50) NOT NULL ,area DECIMAL(10,2) NOT NULL ,rooms INT NOT NULL ,price DECIMAL(10,2) NOT NULL)");
